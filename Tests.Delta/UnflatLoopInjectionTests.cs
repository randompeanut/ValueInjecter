...
namespace Tests.Delta
{
    public class UnflatLoopInjectionTests
    {
        ...
        public void ShouldMapFlatInterfaceProperty()
        {
            ...
            unflat.InjectFrom(new Omu.ValueInjecter.Delta.Injections.UnflatLoopInjection((prop, obj) =>
                { 
        ...
        public class StrToIntUnflat : Omu.ValueInjecter.Delta.Injections.UnflatLoopInjection
        {
